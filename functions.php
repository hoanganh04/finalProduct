<?php 
	...
	$user_id = 1;
	// connect to database
	$db = mysqli_connect("cs1.ucc.ie", "awf1", "Shochel2", "2021_awf1");
	...
	// Receives a user id and returns the fname
	function getUsernameById($id)
	{
		global $db;
		$result = mysqli_query($db, "SELECT fname FROM users WHERE id=" . $id . " LIMIT 1");
		// return the fname
		return mysqli_fetch_assoc($result)['fname'];
	}
	// Receives a comment id and returns the fname
